...
class AppCupertinoTabBar extends StatefulWidget {
  ...
  ///Set this value to true if you want separator lines to be displayed between the [widgets].
  final bool useSeparators;

  ///Set this value to true if you want a shadow to be displayed under the indicator.
  final bool useShadow;

  ///Breaking Change: Previously named [horizontalPadding]. The gap that is to be shown on the left and right sides of each [Widget] in the [widgets].
  final double innerHorizontalPadding;

  ///Breaking Change: Previously named [verticalPadding]. The gap that is to be shown on the top and bottom sides of each [Widget] in the [widgets].
  ...
  @override
  _AppCupertinoTabBarState createState() {
    return _AppCupertinoTabBarState();
  }
}

class _AppCupertinoTabBarState extends State<AppCupertinoTabBar>
            ...
            children: List<Widget>.generate(
              ...
              if (!widget.useSeparators || index % 2 == 0) {
                ...
                return _Separator(
                  _separatorHeight,
                  _separatorWidth,
                  widget.separatorColor ?? widget.foregroundColor,
                );
              }
            }),
          ),
