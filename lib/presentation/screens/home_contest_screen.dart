...
import 'package:stalkmobile/data/static/ApplicationInitSettings.dart';
import 'package:stalkmobile/data/static/BottomNavigateBarList.dart';
import 'package:stalkmobile/data/static/enum/ContestStatusEnum.dart';
import 'package:stalkmobile/data/static/enum/RouteNameEnum.dart';
import 'package:stalkmobile/data/static/enum/SortEnum.dart';
import 'package:stalkmobile/data/static/enum/contest_mode_enum.dart';
...
import 'package:stalkmobile/presentation/components_v2/AppButton.dart';
import 'package:stalkmobile/presentation/components_v2/AppCarousel.dart';
...
import 'package:stalkmobile/presentation/components_v2/bottom_sheet/app_bottom_sheet.dart';
...
import 'package:stalkmobile/presentation/screens_v2/card/card_history_transaction_screen.dart';
import 'package:stalkmobile/presentation/screens_v2/feature/app_notification_screen.dart';
import 'package:stalkmobile/presentation/screens_v2/feature/feature_screen.dart';
import 'package:stalkmobile/presentation/screens_v2/ticket/purchase_ticket_screen.dart';
import 'package:stalkmobile/presentation/screens_v2/contest/contest_all_screen.dart';
import 'package:stalkmobile/presentation/screens_v2/contest/contest_detail_screen.dart';
import 'package:stalkmobile/utils/Service/NotificationProcessService.dart';
import 'package:stalkmobile/utils/router/RouteNavigation.dart';
...
import 'package:stalkmobile/utils/theme/app_constant.dart';
...
class _HomeContestScreenState extends State<HomeContestScreen>
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      if (ApplicationInitSettings.instance.trainingMessage != null) {
        await NotificationProcessService(context)
            .handleOpenAppFirebaseNotification(
            ApplicationInitSettings.instance.trainingMessage!,
            isTraining: true);

        ApplicationInitSettings.instance.trainingMessage = null;
      }
    });
  }
